                    ...
                    {columns.map((column, colIndex) => (
                        <td
                            ...
                            <div
                                ...
                                style={{
                                    width:
                                        column.key === 'sNo' ? '40px' : '50%',
                                    height: '20px',
                                    borderRadius: '8px',
                                    animation: `pulse 1.5s ease-in-out ${rowIndex * 0.1 + colIndex * 0.05
                                        }s infinite`,
                                }}
                            />
                        </td>
                                ...
                                {[1, 2, 3].map((_, i) => (
                                    <div
                                        ...
                                        style={{
                                            width: '32px',
                                            height: '32px',
                                            animation: `pulse 1.5s ease-in-out ${rowIndex * 0.1 + i * 0.05
                                                }s infinite`,
                                        }}
                                    />
                                ))}
                    ...
                    <tr className={styles.units_table_tr}>
                        {columns.map((column) => (
                            <th
                                ...
                                className={
                                    sortable ? styles.thSortable : styles.th
                                }>
                                {column.label}
                        ...
                        {(showActions || onEdit || onDelete || onView || onPayment) && <th>Actions</th>}
                    </tr>
                </thead>
                {loading ? (
                    <TableSkeleton
                        ...
                        {paginatedData.length > 0 ? (
                            ...
                            <tr>
                                <td
                                    colSpan={
                                        columns.length +
                                        ((showActions || onEdit || onDelete || onView || onPayment) ? 1 : 0)
                                    }>
                                    <div className={styles.emptyMessage_info}>
                                        {emptyMessage}
                                    </div>
                                </td>
                            </tr>
                        ...
                        <div className={styles.pagination_controls}>
                            <div
                                ...
                                style={{
                                    ...
                                    height: '32px',
                                    animation:
                                        'pulse 1.5s ease-in-out 0.1s infinite',
                                }}
                            />
                            {[1].map((_, i) => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        height: '32px',
                                        borderRadius: '8px',
                                        animation: `pulse 1.5s ease-in-out ${0.2 + i * 0.1
                                            }s infinite`,
                                    }}
                                />
                            ))}
