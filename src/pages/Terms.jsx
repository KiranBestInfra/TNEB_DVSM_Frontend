...
const Terms = () => {
  return (
    <div className='terms_content'>
      ...
      <section>
        <h2 className="title">2. Use License</h2>
        <p>
      ...
      <section>
        <h2 className="title">3. Disclaimer</h2>
        <p>
          The materials on this website are provided on an 'as is' basis. We make no warranties, expressed or implied, and hereby disclaim and negate all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
        </p>
        <p>
          Furthermore, we do not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on our website or otherwise relating to such materials or on any sites linked to this site.
        </p>
      </section>

      <section>
        <h2 className="title">4. Limitations</h2>
        <p>
      ...
      <section>
        <h2 className="title">5. Revisions and Errata</h2>
        <p>
      ...
      <section>
        <h2 className="title">7. Site Terms of Use Modifications</h2>
        <p>
      ...
      <section>
        <h2 className="title">8. Governing Law</h2>
        <p>
