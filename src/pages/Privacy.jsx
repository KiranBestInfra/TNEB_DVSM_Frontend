...
const Privacy = () => {
  return (
    <div className='terms_content'>
      ...
      <section>
        <h2 className="title">3. Information Sharing</h2>
        <p>
      ...
      <section>
        <h2 className="title">4. Data Security</h2>
        <p>
      ...
      <section>
        <h2 className="title">5. Your Rights</h2>
        <p>
      ...
      <section>
        <h2 className="title">6. Cookies and Tracking</h2>
        <p>
      ...
      <section>
        <h2 className="title">7. Changes to Privacy Policy</h2>
        <p>
      ...
      <section>
        ...
        <p>
          If you have any questions about this privacy policy or our practices, please contact us through the provided channels on our website.
        </p>
      </section>
    </div>
  );
